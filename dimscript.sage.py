...
for s in range(_sage_const_2 , _sage_const_5 ):
    print("--")
    for k in range(_sage_const_2 , _sage_const_5 ):
        print("--")
        for n in range(k * s - k + _sage_const_1 , k * s + _sage_const_1 ):
            if n > _sage_const_20 :
                continue
            m_upper_bound = n
            m_lower_bound = max(m_upper_bound - k - _sage_const_2 , _sage_const_1 )
            for m in range(m_lower_bound, m_upper_bound + _sage_const_1 ):
                ...
                expected_dim = _sage_const_2  * m * k - (max(k + m - n, _sage_const_0 ) ** _sage_const_2 )
