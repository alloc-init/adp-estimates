...
for s in range(_sage_const_1 , _sage_const_7 ):
    print("Enter s = {}".format(s))
    for k in range(_sage_const_2 , _sage_const_7 ):
        m_upper_bound = k * s // _sage_const_2 
        m_lower_bound = max(m_upper_bound - k, _sage_const_1 )
        for m in range(m_lower_bound, m_upper_bound):
            if m > _sage_const_14 :
                continue
            n = _sage_const_2  * m + _sage_const_2 
            ...
            if dim_2m_rk + _sage_const_1  != full:
